          ...
          {!loading && info?.expired && (
            <div className="empty-state" style={{ padding: 40 }}>
              ...
              <div className="empty-desc" style={{ marginBottom: 12 }}>
                {info.ownerName} shared a file with you, but this link has
                expired or reached its download limit.
              </div>
              <div className="text-xs text-muted">
                {info.expiresAt && (
                  <>Expired: {new Date(info.expiresAt).toLocaleDateString()}</>
                )}
                {info.maxDownloads && (
                  <>
                    {" "}
                    · Limit: {info.maxDownloads} download
                    {info.maxDownloads > 1 ? "s" : ""}
                  </>
                )}
              </div>
            </div>
            ...
            <>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                >
                  <span style={{ fontSize: 36 }}>
                    {fileIcon(info.fileMimeType, info.fileName)}
                  </span>
                  <div>
                ...
                {(info.expiresAt || info.maxDownloads) && (
                  <div className="text-xs text-muted" style={{ marginTop: 8 }}>
                    ...
                    {info.maxDownloads && (
                      <>
                        ⬇️ {info.downloadCount}/{info.maxDownloads} downloads
                        used
                      </>
                    )}
                  </div>
              ...
              {!unlocked ? (
                <>
                  ...
                  >
                    Enter the PIN to access this file. The person who shared it
                    should have sent it to you separately.
                  </p>
                ...
                <div>
                  ...
                  >
                    ...
                    <a href="/login" style={{ color: "var(--accent2)" }}>
                      Join AnyShare
                    </a>
                  </p>
                </div>
